...
#endif
#ifndef fLUT_GSTextureName
    #define fLUT_GSTextureName "MultiLut_atlas1.png" // Add your own MultiLUT atlas to \reshade-shaders\Textures\ and provide the new file name in quotes to change the MultiLUT used! This one uses 16 rows at 32px.
#endif
...
uniform int fLUT_MultiLUTSelector <
    ui_category = "Pass 1";
    ui_type = "combo";
    ui_items = "GShade [Angelite-Compatible]\0ReShade 4\0ReShade 3\0Johto\0Espresso Glow\0Faeshade/Dark Veil/HQ Shade/MoogleShade\0ninjafada Gameplay\0seri14\0Yomi\0Neneko\0Yaes\0Ipsusu\0Nightingale\0ReShade PSK\0";
...
uniform int fLUT_LutSelector < 
    ...
    ui_items = "Neutral\0Ipsusu\0IpsusuWarm\0IpsusuPastel\0IpsusuVanilla\0IpsusuAmber\0";
...
#elif MultiLUTTexture_Source == 13 // ReShade PSK
    ui_items = "PSK Original\0PSK Original+\0PSK Natural\0PSK Natural+\0PSK Fantasy\0PSK Fantasy+\0PSK Autumn\0PSK Autumn+\0";
#else
...
#include "ReShade.fxh"
    ...
    #define _SOURCE_MULTILUT_AMOUNT fLUT_LutAmountLow
#elif MultiLUTTexture_Source == 13 // ReShade PSK MultiLut_atlas1.png
    #define _SOURCE_MULTILUT_FILE fLUT_NGETextureName
    #define _SOURCE_MULTILUT_AMOUNT fLUT_LutAmountLow
#endif
